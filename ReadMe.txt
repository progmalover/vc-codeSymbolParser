...
editorDlg.h, editorDlg.cpp - the dialog
    These files contain your CeditorDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in editor.rc, which can be edited in Microsoft Visual C++.
